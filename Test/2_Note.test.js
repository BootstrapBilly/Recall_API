...
describe("Add a note - \x1b[31m expected failures \x1b[37m", () => {
    ...
    test.post("Adds a note with duplicate search tags", "/notes", 424, "A note cannot have duplicate search tags",
    ...
    test.post("Adds a note with duplicate number search tags", "/notes", 424, "A note cannot have duplicate search tags",
    ...
    test.post("Adds a note with mixed duplicate search tags", "/notes", 424, "A note cannot have duplicate search tags",
