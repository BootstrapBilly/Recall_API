...
describe("Login - \x1b[32m expected passes \x1b[37m", () => {
    ...
    test.post_check_res_user_id("Logs in with a standard username and password", "/login", 200, "Login successful", testing_variables.standard_id,
        {
            email: testing_variables.standard_username,
            password: testing_variables.standard_password
        },
    )

    test.post_check_res_user_id("Logs in with a short username and password", "/login", 200, "Login successful", testing_variables.short_id,
        {
            email: testing_variables.short_username,
            password: testing_variables.short_password
        },
    )

    test.post_check_res_user_id("Logs in with a long username and password", "/login", 200, "Login successful", testing_variables.long_id,
        {
            email: testing_variables.long_username,
            password: testing_variables.long_password
        },
    )

    test.post_check_res_user_id("Logs in with a numbers username and password", "/login", 200, "Login successful", testing_variables.numbers_id,
        {
            email: testing_variables.numbers_username,
            password: testing_variables.numbers_password
        },
    )

    test.post_check_res_user_id("Logs in with a caps username and password", "/login", 200, "Login successful", testing_variables.all_caps_id,
        {
            email: testing_variables.all_caps_username,
            password: testing_variables.all_caps_password
        },
    )
