...
describe("Get all notes - \x1b[32m expected passes \x1b[37m", () => {
    ...
    test.post("Usually has 0 notes, granted rights to 1 note", "/get_notes", 200, "notes retrieved",
    ...
    //*Searching
    describe("Searching - \x1b[32m expected passes \x1b[37m", () => {
        ...
        test.post("User with many owned notes, and an additional 2 through access rights, searches using 'e'", "/search", 200, "search executed",
            ...
            "notes", 23,//Expect res.body.notes to have a length of 2
